...
env.hosts = ["ec2-52-215-24-150.eu-west-1.compute.amazonaws.com"
             "ec2-34-251-86-69.eu-west-1.compute.amazonaws.com"]


@hosts("ec2-52-215-24-150.eu-west-1.compute.amazonaws.com")
def deploy_live():
...
@hosts("ec2-52-214-186-194.eu-west-1.compute.amazonaws.com")
def deploy():
    site_folder = f'/home/{env.user}/sites/{env.host}'
    source_folder = site_folder + '/source'
    _create_directory_structure_if_necessary(site_folder)
...
def _update_settings(source_folder, site_name):
    settings_path = source_folder + '/personal_finance/settings.py'
    sed(settings_path, "DEBUG = True", "DEBUG = False")
    sed(settings_path,
        'ALLOWED_HOSTS =.+$',
        f'ALLOWED_HOSTS = ["{site_name}"]'
        )
    secret_key_file = source_folder + '/personal_finance/secret_key.py'
